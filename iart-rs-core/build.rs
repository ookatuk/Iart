fn main() {
    ...
    println!("cargo:rerun-if-env-changed=TRACE_DATABASE_MAX_OFFSET");
    ...
    let trace_database_max_offset =
        std::env::var("TRACE_DATABASE_MAX_OFFSET").unwrap_or_else(|_| "8".to_string());
    ...
    println!(
        "cargo:rustc-env=TRACE_DATABASE_MAX_OFFSET={}",
        trace_database_max_offset
    )
}
